...
<body>
	...
	<div class="page-wrapper">
		...
		<div class="post-slider">
			...
			<h1 class="slider-title">Trending Scholarship Posts</h1>
		...
		<div class="content clearfix">
			...
			<div class="main-content">
				<h1 class="recent-post-title">Recent Scholarship Posts</h1>
			...
			<div class="sidebar">
				<div class="section search">
					...
					<form action="index.html" method="post">
						<input type="text" name="search-term" class="input-text" placeholder="Search...">
					</form>
				</div> <!---///Search---->
